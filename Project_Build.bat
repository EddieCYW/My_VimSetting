...
REM	set VEB_FILE_NAME=Cannonlake
	...
	set WINDDKx86_DIR=D:\WinDDK\7600.16385.1\bin\x86
...
set  CCX86DIR=%WINDDKx86_DIR%\x86
set  CCX64DIR=%WINDDKx86_DIR%\amd64
set TOOLS_DIR=%VEB_TOOLS_DIR%
set      PATH=%VEB_TOOLS_DIR%;%WINDDKx86_DIR%;%CCX86DIR%;%JAVA_BIN_LINK%;C:\windows\system32
